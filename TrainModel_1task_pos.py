...
from network.NN_single import Model_BiLSTM_CRF_withPOS, Model_BiLSTM_CnnDecoder
...
def SelectModel(modelname, sourcevocabsize, targetvocabsize, source_W,
    ...
    elif modelname is 'Model_BiLSTM_CRF_withPOS':
        nn_model = Model_BiLSTM_CRF_withPOS(sourcevocabsize=sourcevocabsize, targetvocabsize=targetvocabsize,
                                                       source_W=source_W,
                                                       input_seq_lenth=input_seq_lenth,
                                                       output_seq_lenth=output_seq_lenth,
                                                       hidden_dim=hidden_dim, emd_dim=emd_dim,
...
if __name__ == "__main__":
    ...
    modelname = 'Model_BiLSTM_CRF_withPOS'
